! function(e, t) {
    ...
    var e, t = (function(e) {
                ...
                return function(e, t) {
                    ...
                    value: function() {
                        this.prototype.Emitter = i, this.prototype.events = ["drop", "dragstart", "dragend", "dragenter", "dragover", "dragleave", "addedfile", "addedfiles", "removedfile", "thumbnail", "error", "errormultiple", "processing", "processingmultiple", "uploadprogress", "totaluploadprogress", "sending", "sendingmultiple", "success", "successmultiple", "canceled", "canceledmultiple", "complete", "completemultiple", "reset", "maxfilesexceeded", "maxfilesreached", "queuecomplete"], this.prototype.defaultOptions = {
                            ...
                            addedfile: function(t, isDir, c) {
                                var i = this;
                                dirCounter++;
                                console.log('previewElement::', isDir)
                                console.log('c value ', c)
                                console.log('dirCounter value ', dirCounter)
                                if(isDir && dirCounter == c) {
                                    dirCounter = 0
                                    console.log('execution')
                                    console.log('element ', this.element)
                                    console.log('previewsContainer ', this.previewsContainer)
                                    console.log('dz-started ', this.element.classList.add("dz-started"))
                                ...
                                } else if (!isDir && dirCounter == c) {
                                    dirCounter = 0
                                    console.log('previewElement::', t.previewElement)                       
                                    if (this.element === this.previewsContainer && this.element.classList.add("dz-started"), this.previewsContainer) {
                                        t.previewElement = b.createElement(this.options.previewTemplate.trim()), t.previewTemplate = t.previewElement, this.previewsContainer.appendChild(t.previewElement);
                                        for (var e = 0, n = n = t.previewElement.querySelectorAll("[data-dz-name]");;) {
                                            if (e >= n.length) break;
                    ...
                    value: function() {
                        ...
                        if ("form" === this.element.tagName && this.element.setAttribute("enctype", "multipart/form-data"), this.element.classList.contains("dropzone") && !this.element.querySelector(".dz-message") && this.element.appendChild(b.createElement('<div class="dz-default dz-message"><span>' + this.options.dictDefaultMessage + "</span></div>")), this.clickableElements.length) {
                            ! function r() {
                                return o.hiddenFileInput && o.hiddenFileInput.parentNode.removeChild(o.hiddenFileInput), o.hiddenFileInput = document.createElement("input"), o.hiddenFileInput.setAttribute("type", "file"), (null === o.options.maxFiles || 1 < o.options.maxFiles) && o.hiddenFileInput.setAttribute("multiple", "multiple"), o.hiddenFileInput.className = "dz-hidden-input", null !== o.options.acceptedFiles && o.hiddenFileInput.setAttribute("accept", o.options.acceptedFiles), null !== o.options.capture && o.hiddenFileInput.setAttribute("capture", o.options.capture), o.hiddenFileInput.style.visibility = "hidden", o.hiddenFileInput.style.position = "absolute", o.hiddenFileInput.style.top = "0", o.hiddenFileInput.style.left = "0", o.hiddenFileInput.style.height = "0", o.hiddenFileInput.style.width = "0", document.querySelector(o.options.hiddenInputContainer).appendChild(o.hiddenFileInput), o.hiddenFileInput.addEventListener("change", function() {
                    ...
                    value: function(o) {
                        ...
                        return function() {
                            for (var e = [], t = 0, i = i = o;;) {
                            	if (t >= i.length) break;
                                var n, r = i[t++];
                                if (null != r.webkitGetAsEntry && (n = r.webkitGetAsEntry())) {
									if (n.isFile) {
										e.push(s.addFile(r.getAsFile()))
									} else {
										if (n.isDirectory) {
											e.push(s._addFilesFromDirectory(n, n.name))
										} else {
											e.push(void 0)
										}
									}
								} else {
									if (null != r.getAsFile && (null == r.kind || "file" === r.kind)) {
										e.push(s.addFile(r.getAsFile()))
									} else {
										e.push(void 0)
									}
                    ...
                    value: function(e, o) {
                    	console.log("_addFilesFromDirectory", e)
                    	var s = this,
                            t = e.createReader(),
                            i = function(t) {
                                    ...
                                    for (var t = 0, i = i = e; !(t >= i.length);) {
                                        ...
                                        n.isFile ? n.file(function(e) {
                                            if (!s.options.ignoreHiddenFiles || "." !== e.name.substring(0, 1)) {
                                                return e.fullPath = o + "/" + e.name, s.addFile(e, true, t)
                                            } 
                    ...
                    key: "accept",
                    value: function(e, t) {
                        return e.size > 1024 * this.options.maxFilesize * 1024 ? t(this.options.dictFileTooBig.replace("{{filesize}}", Math.round(e.size / 1024 / 10.24) / 100).replace("{{maxFilesize}}", this.options.maxFilesize)) : b.isValidFile(e, this.options.acceptedFiles) ? null != this.options.maxFiles && this.getAcceptedFiles().length >= this.options.maxFiles ? (t(this.options.dictMaxFilesExceeded.replace("{{maxFiles}}", this.options.maxFiles)), this.emit("maxfilesexceeded", e)) : this.options.accept.call(this, e, t) : t(this.options.dictInvalidFileType)
                    }
                }, {
                    key: "addFile",
                    value: function(t, isDir = false, c) {
                    	var i = this;
                        newarray.push(t)
                    	c = newarray.length;
                        console.log('addFile addFile::', c)
                    	return t.upload = {
                            uuid: b.uuidv4(),
                            progress: 0,
                            total: t.size,
                        ...
                        }, this.files.push(t), t.status = b.ADDED, this.emit("addedfile", t, isDir, c), this._enqueueThumbnail(t), this.accept(t, function(e) {
                    ...
                    value: function(r, e, t, i, o) {
                        var s = this;
                        return this.createThumbnail(r, e, t, i, !1, function(e, t) {
                            ...
                            return "undefined" != typeof EXIF && null !== EXIF && t && (e = function(e) {
                                ...
                                switch (i.width = t.trgWidth, i.height = t.trgHeight, 4 < e && (i.width = t.trgHeight, i.height = t.trgWidth), e) {
                                    ...
                                    case 5:
                                        ...
                                        break;
                                    case 6:
                                        n.rotate(.5 * Math.PI), n.translate(0, -i.height);
                                        break;
                                    case 7:
                                        n.rotate(.5 * Math.PI), n.translate(i.width, -i.height), n.scale(-1, 1);
                                        break;
                                    case 8:
                                        n.rotate(-.5 * Math.PI), n.translate(-i.width, 0)
                                }
                        ...
                        this._transformFiles(a, function(e) {
                            if (a[0].upload.chunked) {
                                ...
                                if (r.upload.finishedChunkUpload = function(e) {
                                        var t = !0;
                                        e.status = b.SUCCESS, e.dataBlock = null;
        ...
        r.initClass(), r.version = "5.4.0", r.options = {}, r.optionsForElement = function(e) {
    ...
    return t.autoDiscover = !1, {
        ...
        methods: {
            manuallyAddFile: function(e, t) {
                coonsole.log('manuallyAddFile', e)
                if (e.manuallyAdded = !0, this.dropzone.emit("addedfile", e), this.dropzone.options.createImageThumbnails && e.type.match(/image.*/) && e.size <= 1024 * this.dropzone.options.maxThumbnailFilesize * 1024) {
                    t && this.dropzone.emit("thumbnail", e, t);
                    for (var i = e.previewElement.querySelectorAll("[data-dz-thumbnail]"), n = 0; n < i.length; n++) i[n].style.width = this.dropzoneSettings.thumbnailWidth + "px", i[n].style.height = this.dropzoneSettings.thumbnailHeight + "px", i[n].style["object-fit"] = "contain"
                }
